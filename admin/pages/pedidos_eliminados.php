...
<?php $ordenes = Orders::orderList('venta_detalle.tm_delete IS NOT NULL'); /*var_dump($ordenes);*/ ?>
	...
	<a class="btn btn-danger pull-right btn-xs" style="margin-right: 37px" href="<?php echo ADMIN ?>pages/pedidos.php">Volver a pedidos activos</a>
	<br><br>
      				...
      				<tr>     
      					...
      					<td>
      						<span style="font-size: 12px;" class="text-uppercase label <?php echo $label; ?>">
      							<?php echo $orden['estado_es']; ?>
      						</span>
      					</td>

      					<td>
      						<a class="btn btn-xs btn-success btn-block verOrdenBtn" onclick="cargarInfoOrden('<?php echo $orden['serial_venta']; ?>')" data-toggle="modal" data-target="#checkOrder" href="">
      							Ver
      						</a>
  							<form action="<?php echo ADMIN; ?>bd/pedidos/restaurar.php" method="POST">
  								...
  								<input type="submit" class="btn btn-xs btn-danger btn-block" value="RESTAURAR">
  							</form>
      					</td>
			        </tr> 
      			<?php endforeach ?>
