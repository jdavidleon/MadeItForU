...
<?php require DIRECTORIO_ROOT.'admin/inc/header.php'; ?>
	...
	<div class="container" style="margin-bottom: 200px;">
		<?php 
			...
			$serie_buscar = CRUD::all('productos','serie','id_producto = ?',['i',$_GET['id_producto']]); 
			$serie = $serie_buscar[0]['serie'];
			$producto = Products::find($serie); 

			$imagenes = Products::imgProducts($serie);

		?>
		
		<div class="row">
			<div class="col-sm-12">
				<h4><?php echo $producto->nombre_producto_es; ?></h4>
			</div>
			<br><br><br>
		</div>
