        ...
        <div class="modal-content">
          ...
          <form role="form" method="post" action="<?php echo URL_BASE.'admin/bd/productos/nuevo.php'; ?>" enctype="multipart/form-data">
            ...
            <!--  <div class="form-group">
              ...
              <input type="checkbox" data-toggle="toggle" data-on="Publicar" data-off="No publicar aún" data-onstyle="success" data-offstyle="danger" value="SI" name="publicacion">
            </div> -->
            <div class="form-group">
                ...
                <select class="form-control text-capitalized" id="product_to_item" name="id_producto" required>
                  ...
                  <?php foreach ($productos as $producto): ?>
                    <option value="<?php echo $producto['id_producto']; ?>">
                      <?php echo ucfirst($producto['nombre_producto_es']); ?>
                    </option>
                  <?php endforeach ?>
        ...
        <div class="modal-content">
                ...
                <form action="<?php echo URL_BASE.'admin/bd/caracteristicas/cantidad_productos.php'; ?>" method="POST" class="hide carac-form" id="cantidadForm">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="id_producto" id="id_producto">
                      ...
                      <?php foreach ($productos as $producto): ?>
                        <option value="<?php echo $producto['id_producto']; ?>"><?php echo $producto['nombre_producto_es']; ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
              ...
              <!-- CATEGORIA -->
                <form action="<?php echo URL_BASE.'admin/bd/caracteristicas/agregar_categoria.php'; ?>" method="POST" class="hide carac-form" id="catForm">
                  <input type="hidden" name="empt_val">
                  <div class="form-group">
                    <label for="categoria_es">Categoria (Español)</label>
                    <input type="text" class="form-control" placeholder="Categoria (Español)" name="categoria_es" id="categoria_es">
                  </div>
                  <div class="form-group">
                    <label for="categoria_en">Categoria (Inglés)</label>
                    <input type="text" class="form-control" placeholder="Categoria (Inglés)" name="categoria_en">                    
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="id_categoria" id="id_categoria">
                      ...
                      <?php foreach ($categorias as $categoria): ?>
                        <option value="<?php echo $categoria['id_categoria']; ?>"><?php echo $categoria['categoria_es'].' - '.$categoria['categoria_en']; ?></option>
                      <?php endforeach ?>
                    </select>                             
                  </div>
                  <div class="form-group">
                    <label for="nombre_sub_categoria_es">Nombre Sub-categoria (Español)</label>
                    <input type="text" class="form-control" name="nombre_sub_categoria_es" id="nombre_sub_categoria_es" placeholder="Sub-categoria (Español)">
                  </div>                  
                  <div class="form-group">
                    <label for="nombre_sub_categoria_en">Nombre Sub-categoria (Español)</label>
                    <input type="text" class="form-control" name="nombre_sub_categoria_en" placeholder="Sub-categoria (Inglés)" id="nombre_sub_categoria_en">
                  </div>
                  <input type="submit" value="Guardar" class="btn btn-success">
                </form>
              <!-- SUB-CATEGORIA -->
                ...
                <form action="<?php echo URL_BASE.'admin/bd/productos/cupones/create.php'; ?>" method="POST" class="hide carac-form" id="cuponPorProducto">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="id_producto" name="id_producto" required>
                      ...
                      <?php foreach ($productos as $producto): ?>
                        <option value="<?php echo $producto['id_producto'] ?>">
                          <?php echo $producto['nombre_producto_es']; ?> -
