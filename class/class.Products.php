<?php 
	...
	*/
	...
	{	
		...
		public static function cargarProductos($rows='*, productos.id_producto',$where=null,$params=[],$order=null,$limit=null)
		{
	       $join = [
		...
		public static function arrayProductos($pms)
		{
			$datoDescuento = parent::buscarDescuento($pms['id_producto'],$pms['precio']);
          	...
          	$variable = array(
                ...
                'sub-categoria_es' => $pms['nombre_sub_categoria_es'],
                'sub-categoria_en' => $pms['nombre_sub_categoria_en'],
		...
		static public function find($serie)
		{	
			$join = [
            	['INNER','productos_cantidad','productos_cantidad.id_producto = productos.id_producto'],
            	['INNER','productos_imagenes_principales','productos_imagenes_principales.id_producto = productos.id_producto'],
            ...
            $rows = '*, productos.id_producto, categorias.id_categoria, categorias_sub.id_sub_categoria';
            $where = 'productos.serie = ?';
            $params = ['s',$serie];
		...
		static public function consultaPorCategorias($categoriaID)
		{	
	        ...
	        self::$_productos_categoria = self::cargarProductos('*, productos.id_producto',$where,$params,$order,12);
